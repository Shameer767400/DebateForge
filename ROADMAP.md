...
| Video Debates | `useDebateSocket.js` hook pattern ready for WebRTC extension |
| Analytics | `analytics.service.js` scaffold, User model has comprehensive tracking fields |
